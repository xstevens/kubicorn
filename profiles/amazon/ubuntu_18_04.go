...
// NewUbuntuBionicCluster creates a simple Ubuntu Amazon cluster
func NewUbuntuBionicCluster(name string) *cluster.Cluster {
	...
	machineSetsProviderConfigs := []*cluster.MachineProviderConfig{
		{
			ServerPool: &cluster.ServerPool{
				...
				MaxCount: 1,
				MinCount: 1,
				Image:    "ami-0e3e4660d8725dd31",
				Size:     "t2.xlarge",
				BootstrapScripts: []string{
					"bootstrap/amazon_k8s_ubuntu_18.04_master.sh",
				},
		...
		},
		{
			ServerPool: &cluster.ServerPool{
				...
				Size:     "t2.medium",
				BootstrapScripts: []string{
					"bootstrap/amazon_k8s_ubuntu_18.04_node.sh",
				},
				InstanceProfile: &cluster.IAMInstanceProfile{
